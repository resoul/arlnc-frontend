...
import DrawerCloseButton from "@/views/layout/drawer/DrawerCloseButton.vue";
export default {
  name: "Drawer",
  components: {
    'ui-close-btn': DrawerCloseButton,
    'ui-projects-icon': ProjectsIcon,
    'ui-activity-icon': ActivityIcon,
    'ui-calendar-icon': CalendarIcon
  },
  setup() {
  ...
  mounted() {
    const tabWrapper = document.querySelector('.right-sidebar-tab-wrapper');
    const header = document.querySelectorAll('.right-sidebar-header');
...
<template>
  <div id="right-sidebar" class="drawer drawer-right">
    <div :class="{ hidden: !theme.isDrawer }" class="drawer-overlay fixed inset-0 z-[150] bg-slate-900/60"></div>
    <div :class="{ hidden: !theme.isDrawer }" class="drawer-content fixed right-0 top-0 z-[151] h-full w-full sm:w-80">
      <div class="right-sidebar-tab-wrapper w-ful relative flex h-full flex-col bg-white dark:bg-navy-750">
        <div class="flex items-center justify-between py-2 px-4">
          <p data-header="#right-sidebar-tab-home" class="right-sidebar-header flex shrink-0 items-center space-x-1.5">
            <ui-calendar-icon class="size-4" />
            <span class="text-xs">25 May, 2022</span>
          </p>
          <p data-header="#right-sidebar-tab-project" class="right-sidebar-header flex shrink-0 items-center space-x-1.5">
            <ui-projects-icon class="size-4" />
            <span class="text-xs">Projects</span>
          </p>
          <p data-header="#right-sidebar-tab-activity" class="right-sidebar-header flex shrink-0 items-center space-x-1.5">
            <ui-activity-icon class="size-4" />
            <span class="text-xs">Activity</span>
          </p>
          <ui-close-btn />
        </div>

        <div id="right-sidebar-tab-home" class="tab-content tab-shift-up is-scrollbar-hidden overflow-y-auto overscroll-contain pt-1">
          ...
          <div class="mt-3">
            ...
            <div class="scrollbar-sm mt-3 flex space-x-4 overflow-x-auto px-3">
              <div class="relative flex h-28 w-48 shrink-0 flex-col overflow-hidden rounded-xl bg-gradient-to-br from-purple-500 to-indigo-600 p-3">
                <div class="grow">
                  <img
                      class="h-3"
              ...
              <div class="relative flex h-28 w-48 shrink-0 flex-col overflow-hidden rounded-xl bg-gradient-to-br from-pink-500 to-rose-500 p-3">
                <div class="grow">
                  <img
                      class="h-3"
                      src="/images/payments/cc-visa-white.svg"
              ...
              <div class="relative flex h-28 w-48 shrink-0 flex-col overflow-hidden rounded-xl bg-gradient-to-br from-info to-info-focus p-3">
                <div class="grow">
                  <img
                      class="h-3"
                      src="/images/payments/cc-visa-white.svg"
            ...
            <div class="mt-3 grid grid-cols-2 gap-3 px-3">
              <div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
                <div class="flex items-center space-x-2">
                  <img
                      class="size-10"
                      src="/images/100x100.png"                       alt="image"
                  />
                  <div>
                    <h2
        ...
        <div id="right-sidebar-tab-project" class="tab-content tab-shift-up is-scrollbar-hidden overflow-y-auto overscroll-contain px-3 pt-1">
        ...
        <div id="right-sidebar-tab-activity" class="tab-content tab-shift-up is-scrollbar-hidden overflow-y-auto overscroll-contain pt-1">
