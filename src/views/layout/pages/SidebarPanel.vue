...
import SidebarCloseButton from "@/views/layout/sidebar/elements/SidebarCloseButton.vue";
export default {
  components: {
    'ui-simplebar': simplebar,
    'ui-sidebar-close': SidebarCloseButton,
  }
}
</script>
...
<template>
  <div class="flex h-full grow flex-col bg-white pl-[var(--main-sidebar-width)] dark:bg-navy-750">
    ...
    <ui-simplebar class="nav-wrapper h-[calc(100%-4.5rem)] overflow-x-hidden pb-6">
